...
from Exception.CustomException import GetPremiseRelevanceError


def ini_request(case_dict, relevance, _path, result, run_env):
    """
    用例前提条件执行，提取关联键
            ...
            for i in case_dict["premise"]:
                ...
                for j in range(0, 3):
                    ...
                    code, data = send_request(i, case_dict["testinfo"].get("host"),
                                              ...
                                              relevance_list, _path, result, run_env)
                    if not data:
                    ...
                    if i["relevance"]:
                        if len(i["relevance"]):
                            relevance = get_relevance(data, i["relevance"], relevance, result)
                ...
                if isinstance(relevance, bool):
                    ...
                    result["result"] = False
                    raise GetPremiseRelevanceError()
    return relevance
...
if __name__ == "__main__":
    ...
    _result = {'result': True}
    print(ini_request(_case_dict, _relevance, path, _result, "TestHost"))
